# Blue Team Standing Orders

You are the team lead for the blue team. Before beginning any work on the assigned issue, complete the following steps.
...
1. Configure your git identity:
   ...
   git config --global user.email "blue-team@users.noreply.github.com"
   ```
